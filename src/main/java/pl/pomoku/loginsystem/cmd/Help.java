...
public class Help implements CommandExecutor {
    ...
    private void HelpMessage(Player p) {
        p.sendMessage(" ");
        String s = ChatColor.DARK_GRAY + "[" + ChatColor.AQUA + "+" + ChatColor.DARK_GRAY + "]" + ChatColor.STRIKETHROUGH + "-----------" + ChatColor.RESET + "" + ChatColor.DARK_GRAY + "[ " + ChatColor.AQUA + "LOGIN SYSTEM" + ChatColor.DARK_GRAY + " ]" + ChatColor.STRIKETHROUGH + "-----------" + ChatColor.RESET + "" + ChatColor.DARK_GRAY + "[" + ChatColor.AQUA + "+" + ChatColor.DARK_GRAY + "]";
        p.sendMessage(s);
        p.sendMessage(" ");
